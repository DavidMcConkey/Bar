...
cocktails = [
    ...
    },
    {
      ...
      "preparation": "(Optional: if used shake little harder to foam up the egg white). Pour all ingredients into cocktail shaker filled with ice. Shake. Strain into cocktail glass. If served ‘On the rocks’, strain ingredients into old-fashioned glass filled with ice."
    },
    {
      "iba": True,
      "name": "Screwdriver",
    ...
    },
    {
      ...
      "preparation": "Shake and strain into a chilled cocktail glass. The IBA recipe omits the commonly included crème de violette which gives the drink a distinctive purple color."
    },
    {
      "iba": True,
      "name": "Bellini",
